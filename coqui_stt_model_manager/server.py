...
app = Flask(__name__)
CORS(app, origins=["http://localhost:8000", "https://coqui.ai"])
...
def index():
    ...
    return render_template(
        "index.html",
        model_zoo_url=f"http://localhost:8000/models?callback_url=http://{host}:{port}/install_model&prefer_tflite=1",
